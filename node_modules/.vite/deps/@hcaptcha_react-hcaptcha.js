...
function H({ scriptLocation: t, query: e, loadAsync: r = true, crossOrigin: n = "anonymous", apihost: s = "https://js.hcaptcha.com", cleanup: a = true, secureApi: u = false, scriptSource: o = "" } = {}, c) {
  let i = S(t), f = R(i);
