...
const Profile = () => {
  ...
  const handleDataButtonClick = () => {
    setDataButtonClicked(true);
    
    setTimeout(() => {
      setDataButtonClicked(false);
      navigate("/");
    }, 300);
  };
    ...
    <div className="profile-container">
      <div className="profile-frame">
        <div className="profile-card">
          ...
          <div className="profile-text">
            <h1>Bem-vindo!</h1>
            <p>Fulano da Silva de Oliveira</p>
          </div>
        </div>
      </div>
      ...
      <div className="data-section">
        <button 
          ...
          disabled={dataButtonClicked}
        >
          {dataButtonClicked ? 'Carregando...' : 'Meus Dados'}
        </button>
      </div>
      ...
      <div className="articles-section">
        ...
        {hasMoreArticles && !isLoadingMore && (
          <div className="see-more-container">
            <button 
              className={`see-more-button ${showMoreArticles ? 'expanded' : ''}`}
